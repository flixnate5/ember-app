...
module('Acceptance | tutorial app', function (hooks) {
  ...
  test('navigating using the nav-bar', async function (assert) {
    ...
    assert.dom('nav').exists();
    assert.dom('nav.menu a.menu-index').hasText('Tutorial');
    assert.dom('nav.menu a.menu-about').hasText('About');
    assert.dom('nav.menu a.menu-contact').hasText('Contact');
